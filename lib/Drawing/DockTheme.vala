...
namespace Plank
{
	...
	public class DockTheme : Theme
	{
		...
		public Surface create_indicator (int size, Color color, Surface model)
		{
			...
			rg.add_color_stop_rgba (0.4, IndicatorColor.red, IndicatorColor.green, IndicatorColor.blue, 0);
			rg.add_color_stop_rgba (1, IndicatorColor.red, IndicatorColor.green, IndicatorColor.blue, 0);
